import { PrismaClient, UserRole, UserStatus, VehicleType, DriverStatus } from "@prisma/client";
import bcrypt from "bcryptjs";

const prisma = new PrismaClient();

const translations: Array<{ key: string; zh: string; vi: string; groupName: string }> = [
...
async function main() {
  ...
  await prisma.driver.upsert({
    ...
    create: {
      ...
      vehicleType: VehicleType.TON_3_5,
